...
local function new_control_allocation(t, s)
  ...
  if naloc_right >= 0 then
    SRV_Channels:set_output_pwm_chan_timeout(1, math.min(2 * naloc_right + pwm1_trim_value, 1800), 300)
    SRV_Channels:set_output_pwm_chan_timeout(2, math.min(2 * naloc_right + pwm2_trim_value, 1800), 300)
  ...
  if naloc_right < 0 then
    ...
    SRV_Channels:set_output_pwm_chan_timeout(4, math.min(pwm4_trim_value - 2 * naloc_right, 1800), 300)
  end

  if naloc_left >= 0 then
    SRV_Channels:set_output_pwm_chan_timeout(0, math.min(2 * naloc_left + pwm0_trim_value, 1800), 300)
    SRV_Channels:set_output_pwm_chan_timeout(3, math.min(2 * naloc_left + pwm3_trim_value, 1800), 300)
  ...
  if naloc_left < 0 then
    ...
    SRV_Channels:set_output_pwm_chan_timeout(5, math.min(pwm5_trim_value - 2 * naloc_left, 1800), 300)
  end
