...
gnome-terminal -- bash -c "sim_vehicle.py -L SEParnaiba -S 5 -v Rover --sysid 1  --instance 0 -f rover-skid --out=udp:127.0.0.1:14551 --add-param-file nrover.param; exec bash"

# Terminal para Robô 2
gnome-terminal -- bash -c "sim_vehicle.py -L SEParnaiba -S 5 -v Rover --sysid 2 --instance 1 -f rover-skid --out=udp:127.0.0.1:14552 --add-param-file nrover.param; exec bash"
